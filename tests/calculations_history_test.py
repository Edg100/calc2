...
def clear_history_fixture():
    """ This is a fixure that defines a function for testing"""
...
def test_add_calculation_to_history(clear_history_fixture, setup_multiplication_calculation_fixture):
    """ This is to test clear history and returns true for success"""
    # pylint: disable=line-too-long
...
def test_get_calc_last_result_value(clear_history_fixture, setup_multiplication_calculation_fixture):
...
def test_history_count(clear_history_fixture, setup_multiplication_calculation_fixture):
    """Testing getting the count of calculations from the history"""
    # pylint: disable=unused-argument,redefined-outer-name
    assert Calculations.count_history() == 1
def test_get_calc_last_result_object(clear_history_fixture, setup_multiplication_calculation_fixture):
    """Testing getting the last calculation from the history"""
    # pylint: disable=line-too-long
    # pylint: disable=unused-argument,redefined-outer-name,singleton-comparison
